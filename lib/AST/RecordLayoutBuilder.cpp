...
RecordLayoutBuilder::LayoutNonVirtualFirstBase(const CXXRecordDecl *RD) {
...
void
RecordLayoutBuilder::LayoutNonVirtualSecondaryBase(const CXXBaseSpecifier& I) {
  // Ignore virtual bases.
  if (I.isVirtual())
    return;
...
bool RecordLayoutBuilder::verifyDataOnlyUnion(const RecordDecl* RD)
{
