...
RValue CodeGenFunction::EmitBuiltinExpr(const FunctionDecl *FD,
  ...
  case Builtin::BI__builtin_bzero: {
    ...
    Builder.CreateMemSet(Dest.first, Builder.getInt8(0), SizeVal,
                         Dest.second, false, NULL, getTarget().isByteAddressable());
  ...
  case Builtin::BI__builtin_memcpy: {
    ...
    Builder.CreateMemCpy(Dest.first, Src.first, SizeVal, Align, false, NULL, NULL, getTarget().isByteAddressable());
    return RValue::get(Dest.first);
  }
  ...
  case Builtin::BI__builtin_memmove: {
    ...
    Builder.CreateMemMove(Dest.first, Src.first, SizeVal, Align, false, NULL, getTarget().isByteAddressable());
    return RValue::get(Dest.first);
  }
  ...
  case Builtin::BI__builtin_memset: {
    ...
    Builder.CreateMemSet(Dest.first, ByteVal, SizeVal, Dest.second, false, NULL, getTarget().isByteAddressable());
    return RValue::get(Dest.first);
  }
