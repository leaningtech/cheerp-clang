...
CodeGenFunction::EmitNullInitialization(llvm::Value *DestPtr, QualType Ty) {
  ...
  if (!CGM.getTypes().isZeroInitializable(Ty)) {
    ...
    Builder.CreateMemCpy(DestPtr, SrcPtr, SizeVal, Align.getQuantity(), false, NULL, NULL, getTarget().isByteAddressable());
    return;
  }
  ...
  Builder.CreateMemSet(DestPtr, Builder.getInt8(0), SizeVal,
                       Align.getQuantity(), false, NULL, getTarget().isByteAddressable());
}
