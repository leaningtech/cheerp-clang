// RUN: %clang_cc1 -std=gnu++98 -triple x86_64-unknown-unknown %s -Wno-null-conversion -fsyntax-only -verify
// RUN: %clang_cc1 -std=gnu++98 -triple i686-unknown-unknown %s -Wno-null-conversion -fsyntax-only -verify
