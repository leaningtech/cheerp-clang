...
// CHECK: @__llvm_profile_data__Z3foov = hidden constant { i32, i32, i64, i8*, i64* } { i32 7, i32 1, i64 {{[0-9]+}}, i8* bitcast ([7 x i8]* @__llvm_profile_name__Z3foov to i8*), i64* bitcast ([1 x i64]* @__llvm_profile_counters__Z3foov to i64*) }, section "__DATA,__llvm_prf_data", align 8
...
// CHECK: @__llvm_profile_data__Z8foo_weakv = weak hidden constant { i32, i32, i64, i8*, i64* } { i32 12, i32 5, i64 {{[0-9]+}}, i8* bitcast ([12 x i8]* @__llvm_profile_name__Z8foo_weakv to i8*), i64* bitcast ([5 x i64]* @__llvm_profile_counters__Z8foo_weakv to i64*) }, section "__DATA,__llvm_prf_data", align 8
...
// CHECK: @__llvm_profile_data_main = hidden constant { i32, i32, i64, i8*, i64* } { i32 4, i32 1, i64 {{[0-9]+}}, i8* bitcast ([4 x i8]* @__llvm_profile_name_main to i8*), i64* bitcast ([1 x i64]* @__llvm_profile_counters_main to i64*) }, section "__DATA,__llvm_prf_data", align 8
...
// CHECK: @__llvm_profile_data__Z10foo_inlinev = linkonce_odr hidden constant { i32, i32, i64, i8*, i64* } { i32 15, i32 7, i64 {{[0-9]+}}, i8* bitcast ([15 x i8]* @__llvm_profile_name__Z10foo_inlinev to i8*), i64* bitcast ([7 x i64]* @__llvm_profile_counters__Z10foo_inlinev to i64*) }, section "__DATA,__llvm_prf_data", align 8
