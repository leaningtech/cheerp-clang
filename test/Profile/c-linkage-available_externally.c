...
// CHECK: @__llvm_profile_data_foo = linkonce_odr hidden constant { i32, i32, i64, i8*, i64* } { i32 3, i32 1, i64 {{[0-9]+}}, i8* bitcast ([3 x i8]* @__llvm_profile_name_foo to i8*), i64* bitcast ([1 x i64]* @__llvm_profile_counters_foo to i64*) }, section "__DATA,__llvm_prf_data", align 8
