...
// ARM: call arm_aapcscc void @__atomic_load(i32 100, i8* bitcast ([100 x i8]* @a1 to i8*), i8* bitcast ([100 x i8]* @a2 to i8*)
// ARM: call arm_aapcscc void @__atomic_store(i32 100, i8* bitcast ([100 x i8]* @a1 to i8*), i8* bitcast ([100 x i8]* @a2 to i8*)
...
// MIPS32: call void @__atomic_load(i32 100, i8* bitcast ([100 x i8]* @a1 to i8*), i8* bitcast ([100 x i8]* @a2 to i8*)
// MIPS32: call void @__atomic_store(i32 100, i8* bitcast ([100 x i8]* @a1 to i8*), i8* bitcast ([100 x i8]* @a2 to i8*)
...
// MIPS64: call void @__atomic_load(i64 100, i8* bitcast ([100 x i8]* @a1 to i8*)
// MIPS64: call void @__atomic_store(i64 100, i8* bitcast ([100 x i8]* @a1 to i8*), i8* bitcast ([100 x i8]* @a2 to i8*)
}
