...
// ITANIUM: @f1.x = internal global i8* bitcast ([6 x i8]* @.str to i8*)
// MSABI: @f1.x = internal global i8* bitcast ([6 x i8]* @"\01??_C@_05CJBACGMB@hello?$AA@" to i8*)
// CHECK: @f2.x = internal global [6 x i8] c"hello\00", align [[ALIGN]]
// CHECK: @f3.x = internal global [8 x i8] c"hello\00\00\00", align [[ALIGN]]
// ITANIUM: @f4.x = internal global %struct.s { i8* bitcast ([6 x i8]* @.str to i8*) }
// MSABI: @f4.x = internal global %struct.s { i8* bitcast ([6 x i8]* @"\01??_C@_05CJBACGMB@hello?$AA@" to i8*) }
