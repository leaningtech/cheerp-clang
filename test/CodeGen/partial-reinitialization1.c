...
// CHECK: @l3 = global %struct._Z2P3 { %struct._Z2Q3 { %struct._Z2R1 { i32 1, i32 2, i32 3 }, %struct._Z2R2 { i32 0, i32 10, i32 0 } } }
struct P3 l3 = {
...
// A three-pass test
// CHECK: @l5 = global %struct._Z2P5 { i32 1, %struct._Z2Q5 { i32 6, i32 9, i32 8 }, i32 5 }
