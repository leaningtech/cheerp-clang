    ...
    #pragma clang __debug captured
    {
      ...
      #pragma clang __debug captured
      {
        ...
        *y = param;
        ...
        // CHECK1-NEXT: load %struct._Z1A**
        // CHECK1-NEXT: getelementptr inbounds %struct._Z1A*
        ...
        // CHECK1-DAG: [[Z_ADDR:%.*]] = load %struct._Z1A** [[Z_ADDR_REF]]
        // CHECK1-DAG: [[Z_A_ADDR:%.*]] = getelementptr inbounds %struct._Z1A* [[Z_ADDR]], i{{.+}} 0, i{{.+}} 0
