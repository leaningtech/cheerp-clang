...
// CHECK: define x86_vectorcallcc void @"\01v3@@12"(i32 inreg %a, %"struct.\01?Small@@"* byval align 4 %b, i32 inreg %c)
...
// CHECK: define x86_vectorcallcc void @"\01v4@@28"(i32 inreg %a, %"struct.\01?Large@@"* byval align 4 %b, i32 inreg %c)
// X64: define x86_vectorcallcc void @"\01v4@@40"(i32 %a, %"struct.\01?Large@@"* %b, i32 %c)
...
// CHECK: define x86_vectorcallcc void @"\01hfa2@@72"(double %a.0, double %a.1, double %a.2, double %a.3, %"struct.\01?HFA4@@"* inreg %b, double %c)
// X64: define x86_vectorcallcc void @"\01hfa2@@72"(double %a.0, double %a.1, double %a.2, double %a.3, %"struct.\01?HFA4@@"* align 8 %b, double %c)
...
// CHECK: define x86_vectorcallcc void @"\01hfa3@@56"(double %a, double %b, double %c, double %d, double %e, %"struct.\01?HFA2@@"* inreg %f)
// X64: define x86_vectorcallcc void @"\01hfa3@@56"(double %a, double %b, double %c, double %d, double %e, %"struct.\01?HFA2@@"* align 8 %f)
...
// CHECK: define x86_vectorcallcc void @"\01hfa4@@40"(%"struct.\01?HFA5@@"* byval align 4)
// X64: define x86_vectorcallcc void @"\01hfa4@@40"(%"struct.\01?HFA5@@"* %a)

// Return HFAs of 4 or fewer elements in registers.
static struct HFA2 g_hfa2;
struct HFA2 __vectorcall hfa5(void) { return g_hfa2; }
// CHECK: define x86_vectorcallcc %"struct.\01?HFA2@@" @"\01hfa5@@0"()
// X64: define x86_vectorcallcc %"struct.\01?HFA2@@" @"\01hfa5@@0"()
...
// CHECK: define x86_vectorcallcc void @"\01hva2@@144"(<4 x float> %a.0, <4 x float> %a.1, <4 x float> %a.2, <4 x float> %a.3, %"struct.\01?HVA4@@"* inreg %b, <4 x float> %c)
// X64: define x86_vectorcallcc void @"\01hva2@@144"(<4 x float> %a.0, <4 x float> %a.1, <4 x float> %a.2, <4 x float> %a.3, %"struct.\01?HVA4@@"* align 16 %b, <4 x float> %c)

void __vectorcall hva3(v4f32 a, v4f32 b, v4f32 c, v4f32 d, v4f32 e, struct HVA2 f) {}
// CHECK: define x86_vectorcallcc void @"\01hva3@@112"(<4 x float> %a, <4 x float> %b, <4 x float> %c, <4 x float> %d, <4 x float> %e, %"struct.\01?HVA2@@"* inreg %f)
// X64: define x86_vectorcallcc void @"\01hva3@@112"(<4 x float> %a, <4 x float> %b, <4 x float> %c, <4 x float> %d, <4 x float> %e, %"struct.\01?HVA2@@"* align 16 %f)
