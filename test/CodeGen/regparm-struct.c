...
// CHECK: declare void @f17(%struct._Z3s12* inreg sret, i32 inreg, i32 inreg, i32)
void g17(void) {
  f17(41, 42, 43);
}
...
// CHECK: declare void @f18(%struct._Z3s13* byval align 4, i32 inreg, i32 inreg, i32 inreg)
void g18(void) {
  struct s13 x = {{41}};
  f18(x, 42, 43, 44);
}
