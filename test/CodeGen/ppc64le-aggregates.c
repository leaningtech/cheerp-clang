...
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* %[[TMP2]], i8* bitcast ([9 x float]* getelementptr inbounds (%struct.f9* @global_f9, i32 0, i32 0) to i8*), i64 36, i32 1, i1 false)
