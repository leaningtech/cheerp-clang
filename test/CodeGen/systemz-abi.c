...
// CHECK-LABEL: define void @pass_complex_char(%complex._ZTSc* noalias sret %{{.*}}, %complex._ZTSc* %{{.*}}arg)

_Complex short pass_complex_short(_Complex short arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_short(%complex._ZTSs* noalias sret %{{.*}}, %complex._ZTSs* %{{.*}}arg)

_Complex int pass_complex_int(_Complex int arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_int(%complex._ZTSi* noalias sret %{{.*}}, %complex._ZTSi* %{{.*}}arg)

_Complex long pass_complex_long(_Complex long arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_long(%complex._ZTSl* noalias sret %{{.*}}, %complex._ZTSl* %{{.*}}arg)

_Complex long long pass_complex_longlong(_Complex long long arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_longlong(%complex._ZTSx* noalias sret %{{.*}}, %complex._ZTSx* %{{.*}}arg)

_Complex float pass_complex_float(_Complex float arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_float(%complex._ZTSf* noalias sret %{{.*}}, %complex._ZTSf* %{{.*}}arg)

_Complex double pass_complex_double(_Complex double arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_double(%complex._ZTSd* noalias sret %{{.*}}, %complex._ZTSd* %{{.*}}arg)

_Complex long double pass_complex_longdouble(_Complex long double arg) { return arg; }
// CHECK-LABEL: define void @pass_complex_longdouble(%complex._ZTSe* noalias sret %{{.*}}, %complex._ZTSe* %{{.*}}arg)
...
// CHECK-LABEL: define void @pass_agg_1byte(%struct._Z9agg_1byte* noalias sret %{{.*}}, i8 %{{.*}})

struct agg_2byte { char a[2]; };
struct agg_2byte pass_agg_2byte(struct agg_2byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_2byte(%struct._Z9agg_2byte* noalias sret %{{.*}}, i16 %{{.*}})

struct agg_3byte { char a[3]; };
struct agg_3byte pass_agg_3byte(struct agg_3byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_3byte(%struct._Z9agg_3byte* noalias sret %{{.*}}, %struct._Z9agg_3byte* %{{.*}})

struct agg_4byte { char a[4]; };
struct agg_4byte pass_agg_4byte(struct agg_4byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_4byte(%struct._Z9agg_4byte* noalias sret %{{.*}}, i32 %{{.*}})

struct agg_5byte { char a[5]; };
struct agg_5byte pass_agg_5byte(struct agg_5byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_5byte(%struct._Z9agg_5byte* noalias sret %{{.*}}, %struct._Z9agg_5byte* %{{.*}})

struct agg_6byte { char a[6]; };
struct agg_6byte pass_agg_6byte(struct agg_6byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_6byte(%struct._Z9agg_6byte* noalias sret %{{.*}}, %struct._Z9agg_6byte* %{{.*}})

struct agg_7byte { char a[7]; };
struct agg_7byte pass_agg_7byte(struct agg_7byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_7byte(%struct._Z9agg_7byte* noalias sret %{{.*}}, %struct._Z9agg_7byte* %{{.*}})

struct agg_8byte { char a[8]; };
struct agg_8byte pass_agg_8byte(struct agg_8byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_8byte(%struct._Z9agg_8byte* noalias sret %{{.*}}, i64 %{{.*}})

struct agg_16byte { char a[16]; };
struct agg_16byte pass_agg_16byte(struct agg_16byte arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_16byte(%struct._Z10agg_16byte* noalias sret %{{.*}}, %struct._Z10agg_16byte* %{{.*}})
...
// CHECK-LABEL: define void @pass_agg_float(%struct._Z9agg_float* noalias sret %{{.*}}, float %{{.*}})

struct agg_double { double a; };
struct agg_double pass_agg_double(struct agg_double arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_double(%struct._Z10agg_double* noalias sret %{{.*}}, double %{{.*}})

struct agg_longdouble { long double a; };
struct agg_longdouble pass_agg_longdouble(struct agg_longdouble arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_longdouble(%struct._Z14agg_longdouble* noalias sret %{{.*}}, %struct._Z14agg_longdouble* %{{.*}})
...
// CHECK-LABEL: define void @pass_agg_float_a8(%struct._Z12agg_float_a8* noalias sret %{{.*}}, double %{{.*}})
...
// CHECK-LABEL: define void @pass_agg_float_a16(%struct._Z13agg_float_a16* noalias sret %{{.*}}, %struct._Z13agg_float_a16* %{{.*}})
...
// CHECK-LABEL: define void @pass_agg_nofloat1(%struct._Z12agg_nofloat1* noalias sret %{{.*}}, i64 %{{.*}})

struct agg_nofloat2 { float a; int b; };
struct agg_nofloat2 pass_agg_nofloat2(struct agg_nofloat2 arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_nofloat2(%struct._Z12agg_nofloat2* noalias sret %{{.*}}, i64 %{{.*}})

struct agg_nofloat3 { float a; int : 0; };
struct agg_nofloat3 pass_agg_nofloat3(struct agg_nofloat3 arg) { return arg; }
// CHECK-LABEL: define void @pass_agg_nofloat3(%struct._Z12agg_nofloat3* noalias sret %{{.*}}, i32 %{{.*}})


// Accessing variable argument lists

int va_int(__builtin_va_list l) { return __builtin_va_arg(l, int); }
// CHECK-LABEL: define signext i32 @va_int(%struct._Z13__va_list_tag* %{{.*}})
...
// CHECK-LABEL: define i64 @va_long(%struct._Z13__va_list_tag* %{{.*}})
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define i64 @va_longlong(%struct._Z13__va_list_tag* %{{.*}})
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define double @va_double(%struct._Z13__va_list_tag* %{{.*}})
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 1
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
...
// CHECK-LABEL: define void @va_longdouble(fp128* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}})
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_complex_char(%complex._ZTSc* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_1byte(%struct._Z9agg_1byte* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_2byte(%struct._Z9agg_2byte* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_3byte(%struct._Z9agg_3byte* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_4byte(%struct._Z9agg_4byte* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_8byte(%struct._Z9agg_8byte* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_float(%struct._Z9agg_float* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 1
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 4
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_double(%struct._Z10agg_double* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 1
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 4
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_longdouble(%struct._Z14agg_longdouble* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_float_a8(%struct._Z12agg_float_a8* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 1
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 4
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_float_a16(%struct._Z13agg_float_a16* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_nofloat1(%struct._Z12agg_nofloat1* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_nofloat2(%struct._Z12agg_nofloat2* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
...
// CHECK-LABEL: define void @va_agg_nofloat3(%struct._Z12agg_nofloat3* noalias sret %{{.*}}, %struct._Z13__va_list_tag* %{{.*}}
// CHECK: [[REG_COUNT_PTR:%[^ ]+]] = getelementptr inbounds %struct._Z13__va_list_tag, %struct._Z13__va_list_tag* %{{.*}}, i32 0, i32 0
// CHECK: [[REG_COUNT:%[^ ]+]] = load i64, i64* [[REG_COUNT_PTR]]
// CHECK: [[FITS_IN_REGS:%[^ ]+]] = icmp ult i64 [[REG_COUNT]], 5
// CHECK: br i1 [[FITS_IN_REGS]],
