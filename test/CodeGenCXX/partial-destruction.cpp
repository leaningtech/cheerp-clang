...
namespace test0 {
  ...
  // CHECK:      [[E1:%.*]] = getelementptr inbounds [[A]], [[A]], [[A]], [[A]]* [[E_BEGIN]], i64 1
  // CHECK-NEXT: store [[A]]* [[E1]], [[A]]** [[ENDVAR]]
  // CHECK-NEXT: invoke void @_ZN5test01AC1Ei([[A]]* [[E1]], i32 7)
  // CHECK:      [[E2:%.*]] = getelementptr inbounds [[A]], [[A]], [[A]], [[A]]* [[E1]], i64 1
  ...
  // CHECK:      [[E_NEXT]] = getelementptr inbounds [[A]], [[A]], [[A]], [[A]]* [[E_CUR]], i64 1
...
namespace test1 {
  ...
  // CHECK-NEXT: [[X:%.*]] = getelementptr inbounds [[B]], [[B]], [[B]], [[B]]* [[V]], i32 0, i32 0
  // CHECK-NEXT: call void @_ZN5test11AC1Ei([[A:%.*]]* [[X]], i32 5)
  // CHECK-NEXT: [[Y:%.*]] = getelementptr inbounds [[B]], [[B]], [[B]], [[B]]* [[V]], i32 0, i32 1
  // CHECK-NEXT: invoke void @_ZN5test11AC1Ei([[A]]* [[Y]], i32 6)
  // CHECK:      [[Z:%.*]] = getelementptr inbounds [[B]], [[B]], [[B]], [[B]]* [[V]], i32 0, i32 2
  // CHECK-NEXT: invoke void @_ZN5test11AC1Ei([[A]]* [[Z]], i32 7)
  // CHECK:      [[W:%.*]] = getelementptr inbounds [[B]], [[B]], [[B]], [[B]]* [[V]], i32 0, i32 3
...
namespace test2 {
  ...
  void test() {
    ...
    // CHECK:      [[NEXT:%.*]] = getelementptr inbounds [[A]], [[A]], [[A]], [[A]]* [[CUR]], i64 1
