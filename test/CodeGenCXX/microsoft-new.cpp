...
namespace PR13164 {
  void f() {
    ...
    // CHECK: call i8* @"\01??2@YAPAXIUarbitrary_t@@@Z"(i32 16, %"struct.\01?arbitrary_t@@"*
  }
  ...
  void g() {
    ...
    // CHECK: call i8* @"\01??_US@PR13164@@SAPAXIUarbitrary_t@@@Z"(i32 2, %"struct.\01?arbitrary_t@@"*
    S *s1 = new(arbitrary) S;
    // CHECK: call i8* @"\01??2@YAPAXIUarbitrary_t@@@Z"(i32 1, %"struct.\01?arbitrary_t@@"*
  }
  ...
  void h() {
    ...
    // CHECK: call i8* @"\01??_U@YAPAXIUarbitrary2_t@@@Z"(i32 2, %"struct.\01?arbitrary2_t@@"*
  }
}
