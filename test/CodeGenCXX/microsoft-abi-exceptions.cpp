// RUN: %clang_cc1 -std=gnu++98 -emit-llvm %s -o - -triple=i386-pc-win32 -mconstructor-aliases -fexceptions -fno-rtti | FileCheck -check-prefix WIN32 %s
...
// WIN32:   invoke void @"\01?getA@@YA?AUA@@XZ"(%"struct.\01?A@@"* sret %{{.*}})
...
// WIN32:   %[[argmem:.*]] = alloca inalloca [[argmem_ty:<{ %"struct.\\01\?A@@", %"struct.\\01\?A@@" }>]]
// WIN32:   %[[arg1:.*]] = getelementptr inbounds [[argmem_ty]]* %[[argmem]], i32 0, i32 1
// WIN32:   invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@XZ"
// WIN32:   invoke void @"\01?TakeRef@@YAXABUA@@@Z"
//
// WIN32:   invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@XZ"(%"struct.\01?A@@"* %[[arg1]])
...
// WIN32:   br i1 %[[cond]]
// WIN32:   invoke x86_thiscallcc void @"\01??1A@@QAE@XZ"(%"struct.\01?A@@"* %[[arg1]])
// WIN32: }
...
// WIN32:   br i1
// WIN32:   call i8* @llvm.stacksave()
// WIN32:   invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@XZ"(%"struct.\01?A@@"* %{{.*}})
// WIN32:   store i1 true
// WIN32:   invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@XZ"(%"struct.\01?A@@"* %{{.*}})
// WIN32:   invoke i32 @"\01?TakesTwo@@YAHUA@@0@Z"
// WIN32:   call void @llvm.stackrestore
...
// WIN32-NOT:  load
// WIN32:      bitcast i8* %{{.*}} to %"struct.\01?B@crash_on_partial_destroy@@"*
// WIN32:      invoke x86_thiscallcc void @"\01??1B@crash_on_partial_destroy@@UAE@XZ"
//
// WIN32-NOT:  load
// WIN32:      bitcast %"struct.\01?C@crash_on_partial_destroy@@"* %{{.*}} to i8*
// WIN32-NOT:  load
// WIN32:      getelementptr inbounds i8* %{{.*}}, i64 4
// WIN32-NOT:  load
// WIN32:      bitcast i8* %{{.*}} to %"struct.\01?A@crash_on_partial_destroy@@"*
