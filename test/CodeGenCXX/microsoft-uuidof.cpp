...
// CHECK: @gr = constant %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab, i32 0, i32 0) to %struct._Z5_GUID*), align 4
const GUID& gr = __uuidof(S1);

// CHECK: @gp = global %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab, i32 0, i32 0) to %struct._Z5_GUID*), align 4
const GUID* gp = &__uuidof(S1);

// CHECK: @cp = global %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ac, i32 0, i32 0) to %struct._Z5_GUID*), align 4
const GUID* cp = &__uuidof(Curly);

// Special case: _uuidof(0)
// CHECK: @zeroiid = constant %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }* @_GUID_00000000_0000_0000_0000_000000000000, i32 0, i32 0) to %struct._Z5_GUID*), align 4
...
// CHECK-DEFINE-GUID: call void @llvm.memcpy.p0i8.p0i8.i32(i8* bitcast (%struct._Z5_GUID* @thing to i8*), i8* bitcast ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ac to i8*), i32 16, i32 4, i1 false)
// CHECK-DEFINE-WRONG-GUID: call void @llvm.memcpy.p0i8.p0i8.i32(i8* bitcast (%struct._Z5_GUID* @thing to i8*), i8* bitcast ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ac to i8*), i32 4, i32 4, i1 false)

// The static initializer for g.
// CHECK-DEFINE-GUID: call void @llvm.memcpy.p0i8.p0i8.i32(i8* bitcast (%struct._Z5_GUID* @g to i8*), i8* bitcast ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab to i8*), i32 16, i32 4, i1 false)
// CHECK-DEFINE-WRONG-GUID: call void @llvm.memcpy.p0i8.p0i8.i32(i8* bitcast (%struct._Z5_GUID* @g to i8*), i8* bitcast ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab to i8*), i32 4, i32 4, i1 false)

#ifdef DEFINE_GUID
void fun() {
  // CHECK-DEFINE-GUID: %s1_1 = alloca %struct._Z5_GUID, align 4
  // CHECK-DEFINE-WRONG-GUID: %s1_1 = alloca %struct._Z5_GUID, align 4
  // CHECK-DEFINE-GUID: %s1_2 = alloca %struct._Z5_GUID, align 4
  // CHECK-DEFINE-WRONG-GUID: %s1_2 = alloca %struct._Z5_GUID, align 4
  // CHECK-DEFINE-GUID: %s1_3 = alloca %struct._Z5_GUID, align 4
  // CHECK-DEFINE-WRONG-GUID: %s1_3 = alloca %struct._Z5_GUID, align 4

  // CHECK-DEFINE-GUID: [[U1:%.+]] = bitcast %struct._Z5_GUID* %s1_1 to i8*
  // CHECK-DEFINE-WRONG-GUID: [[U1:%.+]] = bitcast %struct._Z5_GUID* %s1_1 to i8*
  ...
  // CHECK-DEFINE-GUID: [[U2:%.+]] = bitcast %struct._Z5_GUID* %s1_2 to i8*
  // CHECK-DEFINE-WRONG-GUID: [[U2:%.+]] = bitcast %struct._Z5_GUID* %s1_2 to i8*
  ...
  // CHECK-DEFINE-GUID: [[U3:%.+]] = bitcast %struct._Z5_GUID* %s1_3 to i8*
  // CHECK-DEFINE-WRONG-GUID: [[U3:%.+]] = bitcast %struct._Z5_GUID* %s1_3 to i8*
