...
// CHECK: @gp = global %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }, { i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab, i32 0, i32 0) to %struct._Z5_GUID*), align 4
const GUID* gp = &__uuidof(S1);

// CHECK: @cp = global %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }, { i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ac, i32 0, i32 0) to %struct._Z5_GUID*), align 4
const GUID* cp = &__uuidof(Curly);

// Special case: _uuidof(0)
// CHECK: @zeroiid = constant %struct._Z5_GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }, { i32, i16, i16, [8 x i8] }* @_GUID_00000000_0000_0000_0000_000000000000, i32 0, i32 0) to %struct._Z5_GUID*), align 4
