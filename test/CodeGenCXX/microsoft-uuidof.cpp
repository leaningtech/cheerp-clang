...
// CHECK: @gr = constant %struct._GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab, i32 0, i32 0) to %struct._GUID*), align 4
