...
//CHECK: @"\01?foo@A@@QAE?A?<auto>@@XZ"(%struct.A* %this, %"class.\01?<lambda_1>@?0??foo@A@@QAE?A?<auto>@@XZ@"* noalias sret %[[A_LAMBDA_RETVAL:.*]])
...
//CHECK: @"\01?bar@B@@QAE?A?<auto>@@XZ"(%struct.B* %this, %"class.\01?<lambda_1>@?0??bar@B@@QAE?A?<auto>@@XZ@"* noalias sret %agg.result)
//CHECK: %[[I20:.+]] = getelementptr inbounds %"class.\01?<lambda_1>@?0??bar@B@@QAE?A?<auto>@@XZ@", %"class.\01?<lambda_1>@?0??bar@B@@QAE?A?<auto>@@XZ@"* %agg.result, i32 0, i32 0
