...
// CHECK: [[T2:%.*]] = alloca %struct._Z8Combiner
// CHECK: [[T1:%.*]] = alloca %struct._Z8Combiner
// CHECK: [[T3:%.*]] = call %struct._Z8Combiner* @_ZN8CombinerC1E7S_large(%struct._Z8Combiner* nonnull [[T1]], [9 x i32] %s.coerce)
// CHECK: call void @_ZN8Combiner1fEv(%struct._Z8Combiner* nonnull sret [[T2]], %struct._Z8Combiner* nonnull [[T1]])
// CHECK: [[T4:%.*]] = getelementptr inbounds %struct._Z8Combiner, %struct._Z8Combiner* [[T2]], i32 0, i32 0, i32 0, i32 0
