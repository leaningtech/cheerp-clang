...
// CHECK-LABEL: define void @_ZN1AC2ER10Undeclared(%struct._Z1A* %this, %struct._Z10Undeclared* nonnull %ref) unnamed_addr
// CHECK: call void @_ZN6MemberC1Ei(

// CHECK-LABEL: define void @_ZN1AC1ER10Undeclared(%struct._Z1A* %this, %struct._Z10Undeclared* nonnull %ref) unnamed_addr
...
// CHECK-LABEL: define void @_ZN1BC2ER10Undeclared(%struct._Z1B* %this, %struct._Z10Undeclared* nonnull %ref) unnamed_addr
// CHECK: call void @_ZN1AC2ER10Undeclared(
// CHECK: call void @_ZN6MemberC1Ei(

// CHECK-LABEL: define void @_ZN1BC1ER10Undeclared(%struct._Z1B* %this, %struct._Z10Undeclared* nonnull %ref) unnamed_addr
