...
// CHECK-STATIC-BL:   {{.*}} { i32* bitcast ([2 x i32]* @_ZGR6nested0_ to i32*), i64 2 },
// CHECK-STATIC-BL:   {{.*}} { i32* bitcast ([2 x i32]* @_ZGR6nested1_ to i32*), i64 2 },
// CHECK-STATIC-BL:   {{.*}} { i32* bitcast ([2 x i32]* @_ZGR6nested2_ to i32*), i64 2 }
...
// CHECK-STATIC-BE:   {{.*}} { i32* bitcast ([2 x i32]* @_ZGR6nested0_ to i32*),
