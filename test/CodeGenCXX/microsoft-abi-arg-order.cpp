...
// X86:          ([[argmem_ty:<{ %"struct.\\01\?A@@", %"struct.\\01\?A@@", %"struct.\\01\?A@@" }>]]* inalloca)
...
// X86: call x86_thiscallcc void @"\01??1A@@QAE@XZ"(%"struct.\01?A@@"* %[[a]])
// X86: call x86_thiscallcc void @"\01??1A@@QAE@XZ"(%"struct.\01?A@@"* %[[b]])
// X86: call x86_thiscallcc void @"\01??1A@@QAE@XZ"(%"struct.\01?A@@"* %[[c]])
// X86: ret void

// X64-LABEL: define void @"\01?foo@@YAXUA@@00@Z"
// X64:         (%"struct.\01?A@@"* %[[a:[^,]*]], %"struct.\01?A@@"* %[[b:[^,]*]], %"struct.\01?A@@"* %[[c:[^)]*]])
// X64: call void @"\01??1A@@QEAA@XZ"(%"struct.\01?A@@"* %[[a]])
// X64: call void @"\01??1A@@QEAA@XZ"(%"struct.\01?A@@"* %[[b]])
// X64: call void @"\01??1A@@QEAA@XZ"(%"struct.\01?A@@"* %[[c]])
// X64: ret void
...
// X86: invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@H@Z"(%"struct.\01?A@@"* %[[arg3]], i32 3)
// X86: %[[arg2:[^ ]*]] = getelementptr inbounds [[argmem_ty]]* %[[argmem]], i32 0, i32 1
// X86: invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@H@Z"(%"struct.\01?A@@"* %[[arg2]], i32 2)
// X86: %[[arg1:[^ ]*]] = getelementptr inbounds [[argmem_ty]]* %[[argmem]], i32 0, i32 0
// X86: invoke x86_thiscallcc %"struct.\01?A@@"* @"\01??0A@@QAE@H@Z"(%"struct.\01?A@@"* %[[arg1]], i32 1)
// X86: invoke void @"\01?foo@@YAXUA@@00@Z"([[argmem_ty]]* inalloca %[[argmem]])
// X86: call void @llvm.stackrestore
// X86: ret void
//
//   lpad2:
// X86: call x86_thiscallcc void @"\01??1A@@QAE@XZ"(%"struct.\01?A@@"* %[[arg2]])
// X86: br label
//
//   ehcleanup:
// X86: call x86_thiscallcc void @"\01??1A@@QAE@XZ"(%"struct.\01?A@@"* %[[arg3]])

// X64-LABEL: define void @"\01?call_foo@@YAXXZ"()
// X64: call %"struct.\01?A@@"* @"\01??0A@@QEAA@H@Z"(%"struct.\01?A@@"* %[[arg3:[^,]*]], i32 3)
// X64: invoke %"struct.\01?A@@"* @"\01??0A@@QEAA@H@Z"(%"struct.\01?A@@"* %[[arg2:[^,]*]], i32 2)
// X64: invoke %"struct.\01?A@@"* @"\01??0A@@QEAA@H@Z"(%"struct.\01?A@@"* %[[arg1:[^,]*]], i32 1)
// X64: call void @"\01?foo@@YAXUA@@00@Z"
// X64:       (%"struct.\01?A@@"* %[[arg1]], %"struct.\01?A@@"* %[[arg2]], %"struct.\01?A@@"* %[[arg3]])
// X64: ret void
//
//   lpad2:
// X64: call void @"\01??1A@@QEAA@XZ"(%"struct.\01?A@@"* %[[arg2]])
// X64: br label
//
//   ehcleanup:
// X64: call void @"\01??1A@@QEAA@XZ"(%"struct.\01?A@@"* %[[arg3]])
