...
// CHECK-NEXT: call void @llvm.memcpy.{{.*}}(i8* bitcast (%struct.s* getelementptr inbounds (%struct.s1, %struct.s1* @s, i32 0, i32 0) to i8*), i8* bitcast (%struct.s* @gs to i8*), i64 132, i32 4, i1 true)
...
// CHECK:   call void @llvm.memcpy.{{.*}}(i8* bitcast (%struct.d* @gd to i8*), i8* bitcast (%struct.d* @gd to i8*), i64 132, i32 4, i1 true)
