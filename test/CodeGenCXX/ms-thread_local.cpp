...
// CHECK-DAG: @"\01??$a@X@@3UA@@A" = linkonce_odr thread_local global %"struct.\01?A@@" zeroinitializer, comdat, align 1
// CHECK-DAG: @"\01??__E?$a@X@@YAXXZ$initializer$" = internal constant void ()* @"\01??__E?$a@X@@YAXXZ", section ".CRT$XDU", comdat($"\01??$a@X@@3UA@@A")
template <typename T>
thread_local A a = A();

// CHECK-DAG: @"\01?b@@3UA@@A" = thread_local global %"struct.\01?A@@" zeroinitializer, align 1
