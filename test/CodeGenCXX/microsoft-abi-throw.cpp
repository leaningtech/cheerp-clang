...
// CHECK-DAG: @"_CT??_R0?AUY@@@8??0Y@@QAE@ABU0@@Z8" = linkonce_odr unnamed_addr constant %eh.CatchableType { i32 4, i8* bitcast (%rtti.TypeDescriptor7* @"\01??_R0?AUY@@@8" to i8*), i32 0, i32 -1, i32 0, i32 8, i8* bitcast (%"struct.\01?Y@@"* (%"struct.\01?Y@@"*, %"struct.\01?Y@@"*, i32)* @"\01??0Y@@QAE@ABU0@@Z" to i8*) }, section ".xdata", comdat
...
// CHECK-DAG: @"_CT??_R0?AUW@@@8??0W@@QAE@ABU0@@Z44" = linkonce_odr unnamed_addr constant %eh.CatchableType { i32 4, i8* bitcast (%rtti.TypeDescriptor7* @"\01??_R0?AUW@@@8" to i8*), i32 4, i32 -1, i32 0, i32 4, i8* bitcast (%"struct.\01?W@@"* (%"struct.\01?W@@"*, %"struct.\01?W@@"*, i32)* @"\01??0W@@QAE@ABU0@@Z" to i8*) }, section ".xdata", comdat
...
void f(const Y &y) {
  ...
  // CHECK: call x86_thiscallcc %"struct.\01?Y@@"* @"\01??0Y@@QAE@ABU0@@Z"(%"struct.\01?Y@@"* %[[mem:.*]], %"struct.\01?Y@@"*
  // CHECK: %[[cast:.*]] = bitcast %"struct.\01?Y@@"* %[[mem]] to i8*
