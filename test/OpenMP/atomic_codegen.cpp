...
#pragma omp parallel
  {
      // CHECK: invoke void @_ZN2StC1Ev(%struct._Z2St* [[TEMP_ST_ADDR:%.+]])
      // CHECK: [[SCALAR_ADDR:%.+]] = invoke dereferenceable(4) i32* @_ZN2St3getEv(%struct._Z2St* [[TEMP_ST_ADDR]])
...
#pragma omp atomic read
      b = St().get();
      // CHECK-DAG: invoke void @_ZN2StC1Ev(%struct._Z2St* [[TEMP_ST_ADDR:%.+]])
      // CHECK-DAG: [[SCALAR_ADDR:%.+]] = invoke dereferenceable(4) i32* @_ZN2St3getEv(%struct._Z2St* [[TEMP_ST_ADDR]])
