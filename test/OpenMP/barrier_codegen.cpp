...
// CHECK-DAG: [[EXPLICIT_BARRIER_LOC:@.+]] = {{.+}} [[IDENT_T]] { i32 0, i32 34, i32 0, i32 0, i8* bitcast ([{{[0-9]+}} x i8]* @{{.+}} to i8*) }
// CHECK-DAG: [[LOC:@.+]] = {{.+}} [[IDENT_T]] { i32 0, i32 2, i32 0, i32 0, i8* bitcast ([{{[0-9]+}} x i8]* @{{.+}} to i8*) }
