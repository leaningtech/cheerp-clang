...
@implementation B : A
-(void) foo {
  // CHECK-X86-32: call void bitcast (i8* (%struct._Z11_objc_super*, i8*, ...)* @objc_msgSendSuper to void (%struct._Z11_objc_super*, i8*, i32)*)
  // CHECK-X86-64: call void bitcast (i8* (%struct._Z11_objc_super*, i8*, ...)* @objc_msgSendSuper to void (%struct._Z11_objc_super*, i8*, i32)*)
  [super im1: 1];
}
-(void) bar {
  // CHECK-X86-32: call void (%struct._Z11_objc_super*, i8*, i32, ...)* bitcast (i8* (%struct._Z11_objc_super*, i8*, ...)* @objc_msgSendSuper to void (%struct._Z11_objc_super*, i8*, i32, ...)*)
  // CHECK-X86-64: call void (%struct._Z11_objc_super*, i8*, i32, ...)* bitcast (i8* (%struct._Z11_objc_super*, i8*, ...)* @objc_msgSendSuper to void (%struct._Z11_objc_super*, i8*, i32, ...)*)
  [super im2: 1, 2];
}
