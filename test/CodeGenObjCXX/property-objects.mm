...
// CHECK: call void @_ZN1SC1ERKS_(%class._Z1S* [[AGGTMP:%[a-zA-Z0-9\.]+]], %class._Z1S* dereferenceable({{[0-9]+}}) {{%[a-zA-Z0-9\.]+}})
// CHECK: call void bitcast (i8* (i8*, i8*, ...)* @objc_msgSend to void (i8*, i8*, %class._Z1S*)*)(i8* {{%[a-zA-Z0-9\.]+}}, i8* {{%[a-zA-Z0-9\.]+}}, %class._Z1S* [[AGGTMP]])
...
// CHECK: call void @_ZN1XC1Ev(%struct._Z1X* [[LVTEMP:%[a-zA-Z0-9\.]+]])
// CHECK: call void @_ZN1XC1ERKS_(%struct._Z1X* [[AGGTMP:%[a-zA-Z0-9\.]+]], %struct._Z1X* dereferenceable({{[0-9]+}}) [[LVTEMP]])
// CHECK: call void bitcast (i8* (i8*, i8*, ...)* @objc_msgSend to void (i8*, i8*, %struct._Z1X*)*)({{.*}} %struct._Z1X* [[AGGTMP]])
struct X {
  X();
  X(const X&);
  ~X();
