...
// CHECK:   [[CALL:%.*]] = call nonnull %struct._Z5Quad2IdE* bitcast (i8* (i8*, i8*, ...)* @objc_msgSend to %struct._Z5Quad2IdE* (i8*, i8*)*)(i8* [[THREE]], i8* [[TWO]])
// CHECK:   [[FOUR:%.*]] = load i8** @OBJC_SELECTOR_REFERENCES_2, !invariant.load ![[MD_NUM]]
// CHECK:   [[FIVE:%.*]] = bitcast [[ONET]]* [[ZERO:%.*]] to i8*
// CHECK:   call void bitcast (i8* (i8*, i8*, ...)* @objc_msgSend to void (i8*, i8*, %struct._Z5Quad2IdE*)*)(i8* [[FIVE]], i8* [[FOUR]], %struct._Z5Quad2IdE* nonnull [[CALL]])
...
// CHECK:   [[ONE1:%.*]] = load %struct._Z1A** [[AADDR:%.*]], align 8
// CHECK:   [[TWO1:%.*]] = load i8** @OBJC_SELECTOR_REFERENCES_5, !invariant.load ![[MD_NUM]]
// CHECK:   [[THREE1:%.*]] = bitcast [[TWOT:%.*]]* [[ZERO1:%.*]] to i8*
// CHECK:   call void bitcast (i8* (i8*, i8*, ...)* @objc_msgSend to void (i8*, i8*, %struct._Z1A*)*)(i8* [[THREE1]], i8* [[TWO1]], %struct._Z1A* dereferenceable({{[0-9]+}}) [[ONE1]])
// CHECK:   store %struct._Z1A* [[ONE1]], %struct._Z1A** [[RESULT:%.*]], align 8
