...
// CHECK: [[C:%.*]] = call dereferenceable({{[0-9]+}}) %struct._Z10SetSection* bitcast (i8* (i8*, i8*, ...)* @objc_msgSend
// CHECK: call dereferenceable({{[0-9]+}}) i32* @_ZN10SetSection2atEi(%struct._Z10SetSection* [[C]]
